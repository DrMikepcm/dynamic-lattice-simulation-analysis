...
# --- Simulation runner ---
def run_sim(Krep, NP_val, v_th_val):
...
if __name__ == "__main__":
    ...
    xp_dwarf, yp_dwarf = run_sim(Krep_dwarf, NP, v_th_dwarf)

    print("Running Massive Galaxy Analog...")
    xp_massive, yp_massive = run_sim(Krep_massive, NP_massive, v_th_massive)
    
    # Generate and plot radial profiles
